            ...
            if count %2 != 0:
                ...
                #Perdida en Long
                    if price_last < df_open['stop_lose'].item():
                        ...
                        alert = f' 💸 🤖 💸 \n *Perdida LONG* \n 🚧' + currencie
                        bot_send_text(alert)
                elif price_last > df_open['price'].item()*1.002 or price_last < df_open['stop_lose'].item():
                    df_open['date'] = date
                    df_open['status'] = 'close'
            ...
            if count %2 != 0:
                ...
                if minutes < 15:
                    ...
                    if price_last > df_open['stop_lose'].item():
                        ...
                        alert = f' 💸 🤖 💸 \n *Perdida SHORT* \n 🚧' + currencie
                        bot_send_text(alert)
                elif price_last < df_open['price'].item()*0.998 or price_last > df_open['stop_lose'].item():
                    df_open['date'] = date
                    df_open['status'] = 'close'
                    df_open['result'] = 'tiempo excede'
