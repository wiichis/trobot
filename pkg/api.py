...
def currencies_list():
    return ['ADA-USDT','AVAX-USDT','CFX-USDT','DOT-USDT','MATIC-USDT','SHIB-USDT','BCH-USDT', 'NEAR-USDT','LTC-USDT','APT-USDT']
    # No usar DYDX, OP, LDO, SOL, BNB, XRP, FIL, ICP, LINK, UNI, TRX, ETH, DOGE, TONCOIN
